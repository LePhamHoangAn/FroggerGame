...
public:
	...
	static Vector2 Lerp(const Vector2& a, const Vector2& b, float speed);
...
public:
	...
	//collision boxes for the collsion
	void DrawRectangle(const IntRect& rect, Color color = {255, 255, 255, 200});
